import { reorderTabs, type TabDropPlacement } from '../components/editor/EditorTabStrip';
import type { EditorTab } from './editor-tabs';
import type { LoadedRtonFile } from '../files/loaded-file-items';
import type { JsonValue, RtonBinaryEncoding, StatusState, ViewMode, EditorSurface } from '../domain/rton-codec';
