...
const messages: Record<string, MessageDict> = {
  'zh-CN': {
    ...
    'status.largeRtonOpened': '大型 RTON 已打开，正在后台建立索引',
    ...
    'format.largeDocumentIndexing': '大文件已打开，索引正在后台建立',
  ...
  en: {
    ...
    'status.largeRtonOpened': 'Large RTON opened; building index in the background',
    ...
    'format.largeDocumentIndexing': 'Large file opened; index is building in the background',
